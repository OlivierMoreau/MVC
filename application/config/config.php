...
//config file loaded at run time

/**
 *Define the working environement, 
 *if you're in devellopement set to True to display every errors
...
//This part is completly copy pasted from mini : https://github.com/panique/mini
